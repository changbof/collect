...
String.prototype.getFromList=function(c){
	var arr=this.split(c), i=1, ret = [];
	for(;i<arguments.length;i++) ret.push(arr[arguments[i]-1]);
	return ret.filter(function(v){return v!==undefined}).join(c);
}
